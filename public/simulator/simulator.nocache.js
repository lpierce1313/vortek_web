function simulator() {
  var O = 'bootstrap',
    ...
    _b = 'simulator.devmode.js',
    ac = '670C5E5B64211151B07F0479FBCD969D',
    bc = 'AC8B6E36315349C2A3E4AB8B37CB3C5D',
    cc = 'B3937B651DF6EADD274093369BC149B7',
    dc = 'B527417CB95C85B3FC2D3D8128428781',
    ec = 'D660B904C83648EA734E48D94A2008E2',
    fc = ':',
    gc = '.cache.js',
    hc = 'loadExternalRefs',
    ic = 'end',
  ...
  simulator.__sendStats = r;
  simulator.__moduleName = S;
  simulator.__errFn = null;
  simulator.__moduleBase = U;
  simulator.__softPermutationId = V;
  simulator.__computePropValue = null;
  simulator.__getPropMap = null;
  simulator.__installRunAsyncCode = function() {};
  simulator.__gwtStartLoadingFragment = function() {
    return null
  };
  simulator.__gwt_isKnownPropertyValue = function() {
    return false
  };
  simulator.__gwt_getMetaProperty = function() {
    return null
  };
  var s = null;
  ...
  simulator.__moduleStartupDone = function(e) {
    var f = t[S].bindings;
    t[S].bindings = function() {
      var a = f ? f() : {};
      var b = e[simulator.__softPermutationId];
  ...
  function A(k) {
    ...
    simulator.onScriptDownloaded = function(a) {
      l(function() {
        m(a)
      })
    };
    ...
    n.src = k;
    if (simulator.__errFn) {
      n.onerror = function() {
        simulator.__errFn(S, new Error(nb + code))
      }
    }
    p.getElementsByTagName(ob)[V].appendChild(n)
  }
  simulator.__startLoadingFragment = function(a) {
    return D(a)
  };
  simulator.__installRunAsyncCode = function(a) {
    var b = v();
    var c = b.body;
  ...
  function D(a) {
    ...
    return simulator.__moduleBase + a
  }
  ...
  function F() {
    ...
    simulator.__getPropMap = function() {
      var a = {};
      for (var b in i) {
    ...
    simulator.__computePropValue = k;
    o.__gwt_activeModules[S].bindings = simulator.__getPropMap;
    r(O, $b);
    if (q()) {
      return D(_b)
    }
    ...
    simulator.__softPermutationId = g;
    return D(l + gc)
  }
  ...
  B();
  simulator.__moduleBase = C();
  t[S].moduleBase = simulator.__moduleBase;
  var H = F();
  if (o) {
